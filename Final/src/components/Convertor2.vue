  ...
  <div class="convertor">
    ...
    <main class="convertor-body">
      ...
      <div class="form-group">
        ...
        <input id="cotizacion" type="number" v-model.number="cotizacion" readonly />
      </div>
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      fetchCotizacion()
      intervalo = setInterval(fetchCotizacion, 2000)
    })
    ...
    return { pesos, cotizacion, resultado, timestamp }
  }
}
</script>
